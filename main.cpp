...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Scriv-seeder\n"
...
//TODO change
static const string mainnet_seeds[] = {"seed1.scriv.network", "seed2.scriv.network", "seed3.scriv.network", "seed4.scriv.network", ""};
static const string testnet_seeds[] = {"testnet-seed1.scriv.network", ""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("scriv.network", 7979), true);
  }
  do {
